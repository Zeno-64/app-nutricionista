import type { GrupoPaciente, Sexo } from '../tipos';
 ...
 *
 * Mora no pacote compartilhado porque o painel e o app preenchem o mesmo
 * formulário — e o que ela decide (qual pergunta se aplica a este paciente,
 * o que falta para finalizar) tem de dar a mesma resposta nos dois.
 */
...
/** Estrutural de propósito: o DTO do painel e o do app satisfazem os dois. */
export function contextoDoPaciente(paciente: {
  sexo: Sexo | null;
  grupos: GrupoPaciente[];
}): ContextoPaciente {
